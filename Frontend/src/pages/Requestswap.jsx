...
const RequestSwap = () => {
  const demoUser = {
    ...
    offeredSkills: ['Photoshop', 'Video Editing'],
    wantedSkills: ['Python', 'Public Speaking'],
    feedback: 'Marc is very cooperative and skilled at design.'
  };
      ...
      <div className="max-w-3xl mx-auto bg-white border border-gray-300 rounded-xl p-6 shadow-lg">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-400">
              <img src={demoUser.photo} alt="Profile" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-2/3">
            ...
            <h2 className="text-xl font-semibold mb-2">{demoUser.name}</h2>
            <div className="mb-4">
              <p className="font-medium">Skills Offered:</p>
              <div className="flex flex-wrap gap-2 mt-1">
                {demoUser.offeredSkills.map((skill, idx) => (
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                {demoUser.wantedSkills.map((skill, idx) => (
                  <span key={idx} className="px-2 py-1 bg-gray-200 rounded-full text-sm">{skill}</span>
                ))}
              </div>
            </div>
            <div>
              ...
              <p className="mt-1 text-gray-700 italic">{demoUser.feedback}</p>
            </div>
          </div>
